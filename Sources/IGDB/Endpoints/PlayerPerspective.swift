...
public final class PlayerPerspective: Identifiable, Updatable, Codable {
    ...
    // sourcery:inline:PlayerPerspective.Codable
    ...
    public init(from decoder: Decoder) throws {
        ...
        let container: KeyedDecodingContainer<PlayerPerspective.CodingKeys>?
