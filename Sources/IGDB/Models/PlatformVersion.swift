...
public struct PlatformVersion: Identifiable, Entity, AutoComposable, AutoFilterable, Codable {
    ...
    public let companies: Expander<PlatformVersionCompany>?
    ...
    public let mainManufacturer: Expander<PlatformVersionCompany>?
    ...
    public let releaseDates: Expander<[PlatformVersionReleaseDate]>?
