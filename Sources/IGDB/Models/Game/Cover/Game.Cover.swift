...
extension Game {
    ...
    public final class Cover: Identifiable, Image, Codable {

        /// The API endpoint to request these entities from
        public static var requestPath: String = "covers"
        ...
        // sourcery:inline:Game.Cover.Codable
        ...
        public init(from decoder: Decoder) throws {
            ...
            let container: KeyedDecodingContainer<Game.Cover.CodingKeys>?
